        ...
        <section className="py-24 bg-background">
            <div className="max-w-[1400px] mx-auto px-4">
                <div className="flex flex-col sm:flex-row items-end justify-between mb-16 gap-8">
                    <div>
                        <p className="text-primary uppercase tracking-[0.3em] text-xs font-bold mb-4">Portfolio</p>
                        <h2 className="text-4xl sm:text-6xl font-black text-white uppercase leading-none">GALERİ</h2>
                    </div>
                    <Link
                        href="/galeri"
                ...
                <div className="columns-1 sm:columns-2 lg:columns-4 gap-6 space-y-6">
                    {/* Featured Videos */}
                    {galleryVideos.slice(0, 4).map((src, idx) => (
                        <div key={`vid-${idx}`} className="relative group overflow-hidden rounded-2xl break-inside-avoid shadow-2xl bg-surface">
                            ...
                            />
                            <div className="absolute top-4 right-4 w-8 h-8 bg-black/50 backdrop-blur-md rounded-full flex items-center justify-center pointer-events-none">
