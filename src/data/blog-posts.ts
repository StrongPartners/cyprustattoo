...
Kıbrıs ikliminde en sık yapılan hata, dövmeyi ya tamamen kuru bırakmak ya da aşırı kremlemektir. İdeal yaklaşım ince tabakalar halinde, cildin nefes almasına izin veren, parfümsüz ve cildi tahriş etmeyen bir ürün kullanmaktır. Çok yoğun uygulama ciltte yapışkanlık ve gözenek tıkanıklığı yaratabilir; çok az uygulama ise kuruluk ve kaşıntıyı tetikleyebilir. Sabah ve akşam düzenli bakım, büyük fark yaratır.
      `,
      en: `
...
For users who constantly go to the sea, work outdoors, or stay in the sun for long periods in the summer, black-and-white tattoos may be a safer choice in practical terms. For users who live in more protected areas or can stick to their care routine, color tattoos are quite logical. There is no single correct answer here; it depends on the lifestyle.
  ...
  },
  {
    ...
    title: {
      tr: "Lefkoşa ve Girne'de Dövme: Öğrenci ve Turistlere Özel Karar Rehberi",
      en: "Tattooing in Nicosia and Kyrenia: Decision Guide for Students and Tourists"
    },
    description: {
      tr: "Lefkoşa ve Girne'de dövme yaptıracak öğrenciler ve turistler için lokasyon, planlama, güven ve bakım odaklı rehber.",
      en: "A guide focused on location, planning, trust, and care for students and tourists getting a tattoo in Nicosia and Kyrenia."
    },
    date: "2026-03-03",
    author: "Cyprus Tattoo",
    category: {
    ...
    imageAlt: {
      tr: "Lefkoşa ve Girne dövme stüdyosu rehberi",
      en: "Nicosia and Kyrenia tattoo studio guide"
    },
    content: {
      tr: `
...
## Lefkoşa İçin Karar Süreci

Lefkoşa'da yaşayan ya da eğitim gören kullanıcılar genellikle daha araştırmacıdır. Fiyat, hijyen, ulaşım kolaylığı, randevu düzeni ve sanatçının tarzı gibi başlıklara daha çok dikkat ederler. Öğrenciler için küçük bütçeli ama kaliteli çözümler, flash day etkinlikleri ve minimal işler oldukça popülerdir. Şehir merkezindeki stüdyolar, yerleşik hayatın ritmine uygun randevu seçenekleri sunar.

## Girne İçin Karar Süreci

Girne'de ise turist ve kısa dönem ziyaretçi profili daha baskındır. Bu kullanıcılar genellikle hızlı karar verir ve işlem sonrası bakım planını tatille birlikte yönetmek zorunda kalır. Girne'deki bir stüdyoyu ziyaret etmeden önce "tatilin son günlerine mi bırakmalı?", "havuz ve deniz planı nasıl etkilenir?" gibi sorulara yanıt aramak kritiktir. 

## Planlama ve Güven

Lefkoşa veya Girne'de olmanız fark etmeksizin, stüdyonun hijyen standartları ve sanatçı portfolyosu her zaman önceliğiniz olmalıdır. Şehir bazlı yerleşimlerde ulaşım ve randevu trafiğini önceden planlamak, özellikle yoğun dönemlerde size zaman kazandırır.
      `,
      en: `
The tattoo market in North Cyprus does not appeal to a single type of user. While Nicosia and its surroundings are the center for students, employees, and residents; Kyrenia stands out especially with tourists, short-term visitors, and customers who decide faster.

## Decision Process for Nicosia

Users living or studying in Nicosia are generally more research-oriented. They pay more attention to titles such as price, hygiene, ease of transportation, appointment order, and the style of the artist. For students, small-budget but quality solutions, flash day activities, and minimal works are quite popular. Studios in the city center offer appointment options suitable for the rhythm of residential life.

## Decision Process for Kyrenia

In Kyrenia, the profile of tourists and short-term visitors is more dominant. These users generally decide quickly and have to manage the post-process care plan together with their holiday. Before visiting a studio in Kyrenia, it is critical to seek answers to questions like "is it for the last days of the holiday?", "how do the pool and sea plans get affected?".

## Planning and Trust

Regardless of whether you are in Nicosia or Kyrenia, the studio's hygiene standards and artist portfolio should always be your priority. Planning the transportation and appointment traffic in city-based settlements in advance saves you time, especially during busy periods.
      `
    }
  },
  {
    ...
    content: {
      tr: `
Dövme yaptırmak isteyen kullanıcıların en büyük endişelerinden biri ağrıdır. Bu nedenle ağrı yönetimi, belirsizliği azaltan kritik bir konudur. Kullanıcı çoğu zaman “çok acır mı?” diye sorar; fakat asıl cevap doğru hazırlık ve gerçekçi beklentilerden geçer.
